...
const UUID = process.env.UUID || '16b2b2b5-3e26-4b83-b9eb-e26045bf676e';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'diyige.awsllswa.dpdns.org';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTRhZTc2OTk2YzU0MTIzMjRkMzdhOWRkYTJmZTQzZDIiLCJ0IjoiMjlmODU0ZDQtMjczMS00OWEyLWIzZTktNzVjMTgyZDc4MTMxIiwicyI6Ik1UaGpNbVE1TnpndE4yRmtOeTAwTTJRM0xUazROR010T0RBeE1HUXdOekV6WmpFNSJ9';               // argo固定隧道token或json,留空即使用临时隧道
...
const HY2_PORT = process.env.HY2_PORT || '28286';                 // hy2端口，支持多端口的可以填写，否则留空
...
const CFIP = process.env.CFIP || 'sub.danfeng.eu.org';             // 优选域名或优选IP
